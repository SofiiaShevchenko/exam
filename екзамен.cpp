...
void sum() 
{
	...
	max = ck * (n * dk - ((n * (n + 1)) / 2 - n));  // За допомогою математичного виразу, обчислюємо максимльну суму, 
                                                    //на яку можна реаліхувати путівки (для наочності можна використати таблицю в Excel)
}
...
int main()
{
	...
	cout << "The maximum price of sold trip tickets: " << max << " грн" << endl;
